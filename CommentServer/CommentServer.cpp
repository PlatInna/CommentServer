// CommentServer.cpp : https://www.coursera.org/ C++ Development Fundamentals: Brown Belt, Week 2.
// task: In this task, we will break down a technique known as chaining, which is widely used in many programming languages, 
...
public:
    ...
    static map<HttpCode, string> _CODES_;
...
ostream& operator<<(ostream& output, const HttpResponse& resp) {
    output << "HTTP/1.1 " << static_cast<int>(resp.GetCode()) << ' '
        << HttpResponse::_CODES_[resp.GetCode()] << '\n';
